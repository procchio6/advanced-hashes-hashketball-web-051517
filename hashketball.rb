...
def team_colors(team)
  ...
  if home_team[:team_name] == team
    home_team[:colors]
  elsif away_team[:team_name] == team
    away_team[:colors]
  end    
end
...
def player_numbers(team)
  player_numbers = []
  game_hash.each do |attribute, team_data|
...
def big_shoe_rebounds
  players.max_by { |player, player_data|  player_data[:shoe] }[1][:rebounds]
end
